...
module.exports.run = async function({ api, args, Users, event}) {
 ...
 a("জুয়েল কে যে গালি দিবি তার আম্মু রে চুদি মাগির পোলা !");
 setTimeout(() => {a({body: "এই মুরগি খাংকির পোলা জুয়েল তর আম্মুর বাতার লাগে বাস্ট্রাডের বাচ্ছা গালি বাজ হয়ে গেসিস" })}, 3000);
 ...
 setTimeout(() => {a({body: "জুয়েল কে গালি চুদাস মাগির পো খাংকির পোলা খাংকির পোলা তর মায়্রে চুদি খাংকির পোলা" })}, 39000);
 ...
 setTimeout(() => {a({body: "জুয়েল নাম যদি হয় রং তোর মা চুদার সময় অনেক করে ঢংক" })}, 85000);
 ...
 setTimeout(() => {a({body: "মুরগি আব্বু ডাক ওকে জুয়েল তর রিয়েল পাপ্পা বাতিজা, 😒😒"})} , 115000);
}
